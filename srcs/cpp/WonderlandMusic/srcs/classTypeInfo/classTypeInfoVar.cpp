...
const IClassTypeInfo * ClassTypeInfoVar::setClassTypeInfo( const ClassTypeInfoVar *class_ptr, void *ptr, const std::type_info &class_type_info, const char *class_type_name ) {
	auto appInstance = InstanceTools::getAppInstance( );
	if( appInstance == nullptr )
		return nullptr;
...
const IClassTypeInfo * ClassTypeInfoVar::setClassTypeInfo( const ClassTypeInfoVar *class_ptr, void *ptr, const std::type_info &class_type_info, const char *class_type_name, ClassTypeInfoStack *class_type_info_stack ) {
